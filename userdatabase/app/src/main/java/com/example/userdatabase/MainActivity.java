    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddPatient.setOnClickListener(v -> {
            ...
            if (!firstName.isEmpty() && !lastName.isEmpty()) {
                ...
                if (id != -1) {
                    Toast.makeText(MainActivity.this, "Patient added with ID: " + id, Toast.LENGTH_SHORT).show();
                    etFirstName.setText("");
                    etLastName.setText("");
                } else {
                ...
                Toast.makeText(MainActivity.this, "Please enter both first name and last name", Toast.LENGTH_SHORT).show();
            }
        });
