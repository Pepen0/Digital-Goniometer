...
accel_file = open(
    "Arduino-Code/Computer_simulation/Data_container/yaw/acceleration.txt", "w"
)
gyro_file = open(
    "Arduino-Code/Computer_simulation/Data_container/yaw/gyroscope.txt", "w"
)
dt_file = open("Arduino-Code/Computer_simulation/Data_container/yaw/dt.txt", "w")
